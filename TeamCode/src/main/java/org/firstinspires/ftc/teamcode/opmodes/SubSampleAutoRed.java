...
@Disabled
@Autonomous(name = "Sub Sample Auto Red")
public class SubSampleAutoRed extends PathChainAutoOpMode {
    ...
    private final Pose pickup3Pose = new Pose(24, 128, Math.toRadians(27));
    ...
    protected void buildPathChains() {
        ...
        score1 = follower.pathBuilder()
                ...
                .addParametricCallback(0.1, ()->run(motorActions.spin.slow()))
    ...
    protected void buildTaskList() {
        ...
        PathChainTask pickup1Task = new PathChainTask(intake1, 0.5)
                .setMaxWaitTime(1.25)
                .addWaitAction(0.9, motorActions.extendo.setTargetPosition(500))
                .addWaitAction(1, motorActions.intakeTransfer())
                .addWaitAction(()-> motorControl.getDetectedColor() != Enums.DetectedColor.UNKNOWN,  motorActions.intakeTransfer())
        ...
        PathChainTask pickup2Task = new PathChainTask(intake2, 0.5)
                .setMaxWaitTime(1.25)
                .addWaitAction(0.9, () -> motorControl.getDetectedColor() == Enums.DetectedColor.UNKNOWN,
        ...
        shiftTask = new PathChainTask(null, 0.0)
                // WaitCondition for SHIFT if color != UNKNOWN && color != BLUE
                .setWaitCondition(() ->
                        motorControl.getDetectedColor() != Enums.DetectedColor.UNKNOWN
                                && motorControl.getDetectedColor() != Enums.DetectedColor.BLUE
                )
                .setMaxWaitTime(3.0)
                .addWaitAction(0, motorActions.intakePivot.Grab());

        shiftTask.addWaitAction(0,   motorActions.extendo.setTargetPosition(150));
        shiftTask.addWaitAction(1, motorActions.extendo.setTargetPosition(400));
        // If we see BLUE, do a special SHIFT pattern
        ...
        shiftTask2.addWaitAction(1, motorActions.extendo.setTargetPosition(400));
    ...
    private void checkEarlyColorStop() {
        ...
        if (isShiftOrAlign && (color == Enums.DetectedColor.RED || color == Enums.DetectedColor.YELLOW)) {
            // 1) Stop the path
            stopCurrentPath();
